...
% OUTPUT DIR
OutputDir = cd;
% EarningsProcessDir = cd+"/InputForSteadyState/";
EarningsProcessDir = strcat(OutputDir,'\InputForSteadyState\');
mkdir(OutputDir)
...
if OneAssetNoCapital
    OutputDir2=strcat(OutputDir,'\OneAssetNoCapital\');
    mkdir(OutputDir2)
end

...
if FlagTransNOFS
    ...
    if iteratingtransition
        ...
        % marginal costs
        equmTRANS.mc = max(lminmargcost,(lfirmdiscount-diff([equmTRANS.tfp equmINITSS.tfp])./(equmTRANS.tfp.*deltatransvec) ...
            - alpha*diff([equmTRANS.capital equmINITSS.capital])./(equmTRANS.capital.*deltatransvec) ...
            - alpha*diff([equmTRANS.caputil equmINITSS.caputil])./(equmTRANS.caputil.*deltatransvec) ...
            - (1-alpha)*diff([equmTRANS.labor equmINITSS.labor])./(equmTRANS.labor.*deltatransvec) ) ...
            .* [equmTRANS.pi(2:Ttransition) equmINITSS.pi] * theta./ equmTRANS.elast ...
            + (equmTRANS.elast-1)./equmTRANS.elast - (diff([equmTRANS.pi equmINITSS.pi])./deltatransvec) * theta./ equmTRANS.elast);
        ...
        equmTRANS.investment = diff([equmTRANS.capital equmINITSS.capital])./deltatransvec + equmTRANS.deprec.*equmTRANS.capital;
        ...
        if DividendFundLumpSum
            it = Ttransition;
            equmTRANS.equity(it) = (equmINITSS.equity + equmTRANS.dividend(it)*deltatransvec(it)) / (1+deltatransvec(it)*equmTRANS.ra(it));
        ...
        switch AdjGovBudgetConstraint
            case 1 % adjust spending
                ...
                equmTRANS.lumptransfer = repmat(equmINITSS.lumptransfer,1,Ttransition);
                ...
                if DistributeProfitsInProportion && TaxHHProfitIncome
                    equmTRANS.taxrev = equmTRANS.taxrev + ...
                        equmTRANS.labtax*(1-profdistfrac)*equmTRANS.profit*(1-corptax); 
                end
            ...
            case 3 % adjust debt
                ...
                equmTRANS.govbond(Ttransition) = equmINITSS.govbond;
            ...
            case 4 % adjust proportional tax rate
                ...
                if DistributeProfitsInProportion && TaxHHProfitIncome 
                    equmTRANS.labtax  = (equmTRANS.lumptransfer - corptax*equmTRANS.profit...
                        - equmTRANS.rb*equmINITSS.govbond + equmTRANS.govexp) / ...
                        (equmTRANS.wage*equmTRANS.labor' +...
                        (1-profdistfrac)*equmTRANS.profit*(1-corptax));
                else
                    equmTRANS.labtax  = (equmTRANS.lumptransfer - corptax*equmTRANS.profit - equmTRANS.rb*equmINITSS.govbond + equmTRANS.govexp) / (equmTRANS.wage*equmTRANS.labor); 
                end
        end
...
for it = Ttransition:-1:1
    ...
    if it==Ttransition; V = solnINITSS.V; else; V = solnTRANS.V{it+1}; end
...
% end
    ...
    statsTRANS(it) = v2struct(Ea,Eb,Ec,Elabor,Ed,Ewage,Enetlabinc,Egrosslabinc,Enetprofinc,Egrossprofinc,...
        Einc,Ehours,Enw,FRACa0,FRACa0close,FRACb0,FRACb0close,FRACb0a0,FRACb0aP,FRACbN,FRACnw0,FRACnw0close,FRACb0a0close, ...
        EbN,EbP,Eadjcost,PERCa,PERCb,PERCnw,PERCc,PERCinc,GINIa,GINIb,GINInw,GINIc,GINIinc, GINIlabinc, ...

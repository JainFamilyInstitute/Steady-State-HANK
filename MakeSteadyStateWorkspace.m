close all;
%clearvars -except Time1;
fprintf('Started Creating Steady State Workspace\n'); 

datagrosslabinc         = 69100;
dataannoutput           = 115000;

% BaseOutputDir=strcat('D:\University of Washington\HANK Literature\Codes for Heterogenous Models',...
%     '\myHANKReplication\ReplicateHank-Steady State\');
% BaseOutputDir=strcat(cd,'\');
BaseOutputDir=cd;
%%
...
dcum1       = zeros(ngpa,ngpb,ngpy);
dcum2       = zeros(ngpa,ngpb,ngpy);
dcum4       = zeros(ngpa,ngpb,ngpy);
...
statsINITSS =load('statsINITSS.mat');

initss.GINIa=statsINITSS.GINIa;
initss.GINIb=statsINITSS.GINIb;
initss.GINInw=statsINITSS.GINInw;
initss.GINIc=statsINITSS.GINIc;
initss.GINIinc=statsINITSS.GINIinc;
initss.GINIlabinc=statsINITSS.GINIlabinc;

initss.ill_share_top10pc=statsINITSS.ill_share_top10pc;
initss.ill_share_top1pc=statsINITSS.ill_share_top1pc;
initss.ill_share_top01pc=statsINITSS.ill_share_top01pc;
initss.ill_share_bot50pc=statsINITSS.ill_share_bot50pc;
initss.ill_share_bot25pc=statsINITSS.ill_share_bot25pc;
initss.ill_share_bot10pc=statsINITSS.ill_share_bot10pc;
initss.ill_p10pc=statsINITSS.ill_p10pc;
initss.ill_p50pc=statsINITSS.ill_p50pc;
initss.ill_p90pc=statsINITSS.ill_p90pc;

initss.liq_share_top10pc=statsINITSS.liq_share_top10pc;
initss.liq_share_top1pc=statsINITSS.liq_share_top1pc;
initss.liq_share_top01pc=statsINITSS.liq_share_top01pc;
initss.liq_share_bot50pc=statsINITSS.liq_share_bot50pc;
initss.liq_share_bot25pc=statsINITSS.liq_share_bot25pc;
initss.liq_share_bot10pc=statsINITSS.liq_share_bot10pc;
initss.liq_p10pc=statsINITSS.liq_p10pc;
initss.liq_p50pc=statsINITSS.liq_p50pc;
initss.liq_p90pc=statsINITSS.liq_p90pc;

initss.inc_share_top10pc=statsINITSS.inc_share_top10pc;
initss.inc_share_top1pc=statsINITSS.inc_share_top1pc;
initss.inc_share_top01pc=statsINITSS.inc_share_top01pc;
initss.inc_share_bot50pc=statsINITSS.inc_share_bot50pc;
initss.inc_share_bot25pc=statsINITSS.inc_share_bot25pc;
initss.inc_share_bot10pc=statsINITSS.inc_share_bot10pc;
initss.inc_p10pc=statsINITSS.inc_p10pc;
initss.inc_p50pc=statsINITSS.inc_p50pc;
initss.inc_p90pc=statsINITSS.inc_p90pc;

initss.totinc_share_top10pc=statsINITSS.totinc_share_top10pc;
initss.totinc_share_top1pc=statsINITSS.totinc_share_top1pc;
initss.totinc_share_top01pc=statsINITSS.totinc_share_top01pc;
initss.totinc_share_bot50pc=statsINITSS.totinc_share_bot50pc;
initss.totinc_share_bot25pc=statsINITSS.totinc_share_bot25pc;
initss.totinc_share_bot10pc=statsINITSS.totinc_share_bot10pc;
initss.totinc_p10pc=statsINITSS.totinc_p10pc;
initss.totinc_p50pc=statsINITSS.totinc_p50pc;
initss.totinc_p90pc=statsINITSS.totinc_p90pc;

initss.con_share_top10pc=statsINITSS.con_share_top10pc;
initss.con_share_top1pc=statsINITSS.con_share_top1pc;
initss.con_share_top01pc=statsINITSS.con_share_top01pc;
initss.con_share_bot50pc=statsINITSS.con_share_bot50pc;
initss.con_share_bot25pc=statsINITSS.con_share_bot25pc;
initss.con_share_bot10pc=statsINITSS.con_share_bot10pc;
initss.con_p10pc=statsINITSS.con_p10pc;
initss.con_p50pc=statsINITSS.con_p50pc;
initss.con_p90pc=statsINITSS.con_p90pc;

initss.nw_share_top10pc=statsINITSS.nw_share_top10pc;
initss.nw_share_top1pc=statsINITSS.nw_share_top1pc;
initss.nw_share_top01pc=statsINITSS.nw_share_top01pc;
initss.nw_share_bot50pc=statsINITSS.nw_share_bot50pc;
initss.nw_share_bot25pc=statsINITSS.nw_share_bot25pc;
initss.nw_share_bot10pc=statsINITSS.nw_share_bot10pc;
initss.nw_p10pc=statsINITSS.nw_p10pc;
initss.nw_p50pc=statsINITSS.nw_p50pc;
initss.nw_p90pc=statsINITSS.nw_p90pc;
...
%% Save the workspace
save('Steadystate_workspace_paper.mat');
fprintf('Completed Saving Steady State Workspace\n');

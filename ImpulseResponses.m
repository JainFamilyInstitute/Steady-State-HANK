...
writematrix(deltatransvec',OutputDir+"deltatransvec.txt",'Delimiter','tab');
...
if IncludeMonetaryShock
    ...
    equmTRANS.mpshock = equmINITSS.mpshock + ...
        MonetaryShockSize*MonetaryShockPers.^[0 cumdeltatrans(1:Ttransition-1)];
...
if IncludeForwardGuideShock
    ...
    equmTRANS.mpshock = equmINITSS.mpshock + ForwardGuideShockSize * ...
        MonetaryShockPers.^[zeros(1,itfg) cumsum(deltatransvec(itfg:Ttransition-1))];
    equmTRANS.mpshock(end-nendtrans+1:end) = equmINITSS.mpshock;
